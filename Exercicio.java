...
// criar um syso para pessoas com menos de 16 anos
   ...
   // I
      ...
      System.out.println(" Seu imc é igual a " + peso/(Altura*Altura) + " está abaixo do peso e deve praticar atividades diciceis como: Luta.  Ganhe entre " + ((62.1* Altura - 44.7) - peso) + " Kg para estar no seu peso ideal" );
   // I  
      }if (imc<20 && sexo==2 && idade>5 && idade>16 && idade<25) {
      System.out.println(" Seu imc é igual a " + peso/(Altura*Altura) + " está abaixo do peso e deve praticar atividades dificeis como: Luta.  Ganhe entre " + ((72.7* Altura - 58) - peso) + " Kg para estar no seu peso ideal");
   // II
      }if (imc<20 && sexo==2 && idade>25 && idade<35) {
      System.out.println(" Seu imc é igual a " + peso/(Altura*Altura) + " está abaixo do peso e deve praticar atividades dificeis como: Luta,Musculação Intensa.  Ganhe entre " + ((72.7* Altura - 58) - peso) + " Kg para estar no seu peso ideal");
   // II
      }if (imc<20 && sexo==1 && idade>25 && idade<35) {
      System.out.println(" Seu imc é igual a " + peso/(Altura*Altura) + " está abaixo do peso e deve praticar atividades dificeis como: Luta,Musculação Intensa.  Ganhe entre " + ((62.1* Altura - 44.7) - peso) + " Kg para estar no seu peso ideal");
   // III
   ...
   // IV
      ...
      System.out.println(" Seu imc é igual a " + peso/(Altura*Altura) + " está abaixo do peso e deve praticar atividades dificeis como: Luta,Pilates.  Ganhe entre " + ((62.1* Altura - 44.7) - peso) + " Kg para estar no seu peso ideal");
   // V
      }if (imc<20 && sexo==2 && idade>55 && idade<65) {
      System.out.println(" Seu imc é igual a " + peso/(Altura*Altura) + " está abaixo do peso e deve praticar atividades dificeis.  Ganhe entre " + ((72.7* Altura - 58) - peso) + " Kg para estar no seu peso ideal");
   // V
   ...
   // VI
      ...
      System.out.println(" Seu imc é igual a " + peso/(Altura*Altura) + " está abaixo do peso e deve praticar atividades dificeis como: Pilates.  Ganhe entre " + ((72.7* Altura - 58) - peso) + " Kg para estar no seu peso ideal");
   // VI
